...
const ZONE_DOMAIN: Record<number, { code: string; description: string; minLot: number | null }> = {
  ...
  1:  { code: "BPZ",  description: "Business - Business Park Zone", minLot: 1000 },
  35: { code: "CCZ",  description: "Business - City Centre Zone", minLot: 200 },
  49: { code: "GBZ",  description: "Business - General Business Zone", minLot: 200 },
  5:  { code: "HIZ",  description: "Business - Heavy Industry Zone", minLot: 2000 },
  17: { code: "BPIZ", description: "Business - Light Industry Zone", minLot: 1000 },
  7:  { code: "LCZ",  description: "Business - Local Centre Zone", minLot: 200 },
  10: { code: "MCZ",  description: "Business - Metropolitan Centre Zone", minLot: 200 },
  12: { code: "MUZ",  description: "Business - Mixed Use Zone", minLot: 200 },
  44: { code: "NCZ",  description: "Business - Neighbourhood Centre Zone", minLot: 200 },
  22: { code: "TCZ",  description: "Business - Town Centre Zone", minLot: 200 },
