...
async function buildAll() {
  ...
  for (const file of ["index.html", "site.js", "styles.css", "alpha-icon.svg", "robots.txt", "sitemap.xml"]) {
  ...
  for (const dir of ["privacy", "terms", "support", "contact", "sales-portal", "provider-portal"]) {
