...
export const styles = StyleSheet.create({
  ...
  kvKey: { color: MUTED, fontSize: 10, width: "58%", paddingRight: 10, lineHeight: 1.35 },
  kvVal: { fontFamily: "Helvetica-Bold", fontSize: 10, textAlign: "right", width: "42%", lineHeight: 1.35 },
  kvTotalKey: { fontFamily: "Helvetica-Bold", fontSize: 11, width: "58%", paddingRight: 10, lineHeight: 1.3 },
  kvTotalVal: { fontFamily: "Helvetica-Bold", fontSize: 11, textAlign: "right", width: "42%", lineHeight: 1.3 },
