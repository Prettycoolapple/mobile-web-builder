...
export const styles = StyleSheet.create({
  ...
  coverBody: { paddingHorizontal: 40, paddingTop: 24 },
  coverPhoto: { width: "100%", height: 200, objectFit: "cover", borderRadius: 6, marginBottom: 18 },
  coverSectionLabel: {
    fontSize: 9,
    color: MUTED,
  ...
  coverSummary: { fontSize: 11, lineHeight: 1.6, color: INK, marginBottom: 20 },
  preparedBy: {
    marginTop: 8,
    borderTopWidth: 1,
    borderTopColor: LINE,
  ...
  preparedByName: { fontSize: 12, fontFamily: "Helvetica-Bold" },
  preparedByLine: { fontSize: 9.5, color: MUTED, marginTop: 2 },
  ...
  scoreBigNum: { color: "#ffffff", fontSize: 30, fontFamily: "Helvetica-Bold" },
  scoreBigLabel: { color: "rgba(255,255,255,0.85)", fontSize: 8, textTransform: "uppercase", letterSpacing: 1 },
