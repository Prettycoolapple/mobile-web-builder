...
const FEATURES = [
  { icon: "bar-chart-2" as const, title: "AI Feasibility Reports", desc: "Run unlimited development feasibility analyses for your clients" },
  { icon: "map" as const, title: "Market Intelligence", desc: "Access NZ-wide property development data and zoning insights" },
  { icon: "users" as const, title: "Client Presentations", desc: "Generate professional reports to share with buyers and developers" },
  { icon: "star" as const, title: "Priority Support", desc: "Get dedicated support from our property intelligence team" },
];

export default function WelcomeAgentScreen() {
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        <View style={[styles.iconCircle, { backgroundColor: colors.accent + "15" }]}>
          <Feather name="briefcase" size={36} color={colors.accent} />
        </View>
        ...
        <Text style={[styles.subheading, { color: colors.mutedForeground, fontFamily: "DM_Sans_400Regular" }]}>
          Your Sales Agent account is ready. You have 14 days free, then $99/month.
        </Text>
